...
projects, demonstrating a clear understanding of the role and industry standards.The output must be in following json format [
  { "level": "fresher", "summary": "text" },
  { "level": "mid", "summary": "text" },
  { "level": "experienced", "summary": "text" }
]Each level (fresher, mid, experienced) should have a summary key with a brief text description of relevant experience.`;
